...
export default function AnimatedLandingPage() {
  // Create a ref for the Demo section
      ...
      <div className="relative z-10 w-full">
        ...
        <AnimatedSection>
          <section className="w-full py-12 md:pb-14 md:pt-14">
            {/* Pass the scrollToDemo function to HeroSection */}
        ...
        <main className="flex flex-col w-full max-w-6xl mx-auto">
          ...
          <AnimatedSection>
            <section ref={demoSectionRef} className="w-full md:pt-24">
              {/* The Demo section will be scrolled to */}
              <Demo />
            </section>
          </AnimatedSection>
