...
function Toast({
  ...
  return (
    <div
      id="toast-success"
      className="fixed top-5 right-5 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-gray-400 bg-gray-800 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
      role="alert"
    >
