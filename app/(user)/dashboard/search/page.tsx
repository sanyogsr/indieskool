...
//   const handleEnroll1 = async (tutorialId: number) => {
//     if (!user || !user.id) {
...
//     try {
//       // Fetch the tutorial owner's Stripe account ID
//       const tutorialResponse = await axios.get(`/api/get-tutorials/${tutorialId}`);
